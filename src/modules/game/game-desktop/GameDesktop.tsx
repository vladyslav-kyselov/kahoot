...
const GameDesktop = ({users, changeStage, stage, questions, currentQuestion}: Props) => {
    return (
        <div className="game">
            ...
            {stage === STAGE.QUESTION_AND_ANSWER && <StageFourth changeStage={changeStage} currentQuestion={currentQuestion}/>}
